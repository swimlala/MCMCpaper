...
```{r}
agm.resultnullMixed2 = agm(data.null,seq(0, 3600,100),Nullfunc,3,maxIterations=1000, noise.sd=0.0001, chainNum=5, initialisedParameters = agm.resultnullMixed$posterior.mean, logPrior = "Mixed")
